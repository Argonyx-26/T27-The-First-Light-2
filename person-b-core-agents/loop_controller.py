"""
loop_controller.py -- Person B: Intervention & Verification
============================================================
...
Persistence:
    ...
    Person C reads it; Person A supplies the initial diagnosed state.
...
def _save_live_state(path: str, updated_student: dict[str, Any]) -> None:
    """
    Upsert the updated student into the live-state file.
    - If student_id already exists: replace it in-place.
    - Otherwise: append.
    Never creates duplicate student_id entries.
    """
